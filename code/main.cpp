...
//	FILES
	...
	ofstream stabEigen("/conv1/zfg663/foodwebs/data/beta0.9/1-link/eig_stab.txt");		// eigenvalues of linearly stable food web
	ofstream ustabEigen("/conv1/zfg663/foodwebs/data/beta0.9/1-link/eig_unstab.txt");		// eigenvalues of linearly unstable food web

	// data is saved as:
	// iteration - number of Species - feasibility - stability - convergence
	// 1 - converged, 2 - decreasing amplitude, 9 - not converged
	ofstream webData("/conv1/zfg663/foodwebs/data/beta0.9/1-link/stab_data.txt");				// behavior of food web

	// data is saved as:
	// iteration - l - S(0) - k - a - consumer - eta
	// iteration - l - S(0) - a - consumer/resource - eta - beta*eta	
	ofstream sFile("/conv1/zfg663/foodwebs/data/beta0.9/1-link/species_param.txt");			// Species parameters
	ofstream pFile("/conv1/zfg663/foodwebs/data/beta0.9/1-link/producer_param.txt");			// Producer parameters
